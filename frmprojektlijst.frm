VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmprojektlijst 
   Caption         =   "Projektlijst"
   ClientHeight    =   6888
   ClientLeft      =   48
   ClientTop       =   432
   ClientWidth     =   15492
   HelpContextID   =   5
   OleObjectBlob   =   "frmprojektlijst.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "frmprojektlijst"
...
Dim lngHwnd As LongPtr
  ...
  End If
 'frmprojektlijst.Width = 273
 'frmprojektlijst.Height = 219.75
 On Error Resume Next
'''' frmprojektlijst.Height = 250
'''' frmprojektlijst.Width = 352
...
For Each element In ThisDrawing.ModelSpace
      ...
      Set SYMBOOL = element
        ...
        If ATTRIBUUT.TagString = "BLAD" Then bladz = ATTRIBUUT.textstring
        Next i
       End If
     End If
   End If
...
padz = TextBox16 & TextBox17 & "-wl.txt"

Set f = fs.OpenTextFile(padz, ForWriting, -2)
    f.write Chr(13) + Chr(10)
    f.write "Tekenaar: " & usernaam & " |Datum: " & MyDate
    f.write Chr(13) + Chr(10)
    f.write Chr(13) + Chr(10)
    f.write pad
    f.write teknaam & " - Blad " & bladz
    f.write Chr(13) + Chr(10)
    f.write Chr(13) + Chr(10)
    f.Close
...
'If CheckBox5.Value = False Then
    ...
    For i = 0 To teller - 1
       'Define the text object
        ...
        Set f = fs.OpenTextFile(padz, ForAppending, -2)
        f.write textstring
        f.write Chr(13) + Chr(10)
        f.Close
    ...
    Set f = fs.OpenTextFile(padz, ForAppending, -2)
    f.write Chr(13) + Chr(10)
    f.write "Werkelijke Lengte = " & TextBox12 & " meter."
    f.Close
...
'''''''    If frmprojektlijst.CheckBox4.Value = True Then
'''''''        Set f = fs.OpenTextFile("c:\acad2002\layerlijst.txt", ForAppending, -2)
'''''''        f.write Chr(13) + Chr(10)
'''''''        f.write Chr(13) + Chr(10)
'''''''        f.write "     " & "--------------------------------------------------------------------"
...
'TextBox13 = ThisDrawing.GetVariable("userr2")
 ...
 For Each element In ThisDrawing.ModelSpace
        ...
        End If
    Next element
If WSL = "WTH-ZD" Then frmprojektlijst.OptionButton1 = True
If WSL = "PE-RT" Then
     CheckBox5.Visible = True
     frmprojektlijst.OptionButton2 = True
End If
UNITSJEK1 = Len(UNITSjek)
If UNITSJEK1 = 1 Then frmprojektlijst.CheckBox3.Value = True
End Sub
...
TextBox15 = teknaam
TextBox16 = ThisDrawing.GetVariable("dwgprefix")
